...
Please read these guidelines before contributing to meziantou/Meziantou.OnlineVideoPlayer:
...
If you have questions about how to use meziantou/Meziantou.OnlineVideoPlayer, please open a GitHub issue.
...
- Check that new and updated code follows meziantou/Meziantou.OnlineVideoPlayer's existing code formatting and naming standard
- Run meziantou/Meziantou.OnlineVideoPlayer's unit tests to ensure no existing functionality has been affected
...
By contributing your code to meziantou/Meziantou.OnlineVideoPlayer you grant Gérald Barré a non-exclusive, irrevocable, worldwide,
